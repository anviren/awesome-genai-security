...
9. [AI Security and Red Teaming - Rob Maas (Wiley)](https://www.wiley.com/en-us/AI+Security+and+Red+Teaming-p-9781394336265)
10. [Not with a Bug, But with a Sticker - Ram Shankar Siva Kumar & Hyrum Anderson](https://www.notwithabug.com/)
...
12. [Trail of Bits - AI/ML Security Research](https://blog.trailofbits.com/category/machine-learning/)
...
3. [LLM Attacks - Comprehensive Attack Taxonomy](https://llmattacks.org/)
...
3. [MITRE ATLAS Attack Navigator](https://atlas.mitre.org/matrices/ATLAS)
...
6. [AI-powered Bing Chat spills its secrets via prompt injection attack](https://arstechnica.com/information-technology/2023/02/ai-powered-bing-chat-spills-its-secrets-via-prompt-injection-attack/)
7. [Air Canada Chatbot Provides Wrong Info (2024)](https://www.bbc.com/travel/article/20240222-air-canada-chatbot-misinformation-what-travellers-should-know) - Airline held liable for chatbot hallucinating refund policy.
8. [Microsoft Tay Bot Manipulation (2016)](https://en.wikipedia.org/wiki/Tay_(chatbot)) - Twitter chatbot manipulated into generating offensive content.
...
10. [GitHub Copilot Leaking Secrets (2023)](https://www.gitguardian.com/blog/yes-github-copilot-can-leak-secrets) - AI code assistant reproducing secrets from training data.

## Regulatory Frameworks & Governance
1. [EU AI Act](https://artificialintelligenceact.eu/) - EU regulation on artificial intelligence.
2. [NIST AI 100-1: Artificial Intelligence Risk Management Framework](https://www.nist.gov/artificial-intelligence/executive-order-safe-secure-and-trustworthy-ai)
3. [ISO/IEC 42001:2023 - AI Management System Standard](https://www.iso.org/standard/81230.html)
4. [White House Executive Order on Safe, Secure AI](https://www.whitehouse.gov/briefing-room/presidential-actions/2023/10/30/executive-order-on-the-safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence/)
5. [Singapore AI Governance Framework](https://www.pdpc.gov.sg/help-and-resources/2020/01/model-ai-governance-framework)
...
5. [Protect AI Newsletter](https://protectai.com/newsletter)
